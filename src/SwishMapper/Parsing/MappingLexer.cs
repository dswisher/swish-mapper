...
{
    public class MappingLexer : IDisposable
    {
        private static readonly HashSet<string> Keywords;
        private static readonly HashSet<char> PunctuationStarters;

        private readonly ILogger<MappingLexer> logger;
        ...
        public MappingLexer(string path, ILogger<MappingLexer> logger)
            : this(new StreamReader(path), Path.GetFileName(path), logger)
        {
        }


        public MappingLexer(TextReader reader, string filename, ILogger<MappingLexer> logger)
        {
            this.logger = logger;
            this.reader = reader;
